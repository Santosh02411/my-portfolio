...
window.addEventListener('scroll', () => {
  ...
  header.style.boxShadow = y > 40 ? '0 10px 30px -20px rgba(0,0,0,0.4)' : 'none';
  lastScroll = y;
}, { passive: true });
...
(function () {
  ...
  window.addEventListener('resize', () => { readColors(); resize(); }, { passive: true });
